...
print(dir_)
flag_coo = False # True = Activate this for efficiency on large grids (Com fluxo e mais rapido)
flag_JU  = True  # True = Para calcular o sistema com o fluxo J 
#OBS: Para calcular o sistema primal somente com U, use False nas duas flags acima
flag_mu  = False #  True = Mu constante em todo dominio e False = mu interpolate(item 5) 
